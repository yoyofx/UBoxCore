...
namespace AutoUpdater.utils
{
    ...
    /// 
    /// </remarks>
    public enum EReturnResultState
    {
        /// <summary>
        /// 成功
        /// </summary>
    ...
    public class ReturnResult<T> : ReturnResult
    {
        ...
        /// </summary>
        /// <returns></returns>
        public new static ReturnResult<T> SuccessResult()
        {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public new static ReturnResult<T> SuccessResult(string message)
        {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public new static ReturnResult<T> FailResult(string message)
        {
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        public new static ReturnResult<T> OtherResult(EReturnResultState state)
        {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public new static ReturnResult<T> OtherResult(EReturnResultState state, string message)
        {
